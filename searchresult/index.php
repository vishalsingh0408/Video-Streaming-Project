...
<body>
    ...
    <section id="con">
        <span id="searchBar">
          <span id="searchBack">
            <input type="text" id="text" placeholder="Type something here">
            <i class="fa-solid fa-magnifying-glass" onclick="searchRes()"></i>
          </span>
        ...
        $sql = "SELECT datavideos.id, datavideos.name, datavideos.coverimg, datavideos.chid, channels.chid, channels.chname, channels.icon 
        from datavideos inner join channels on channels.chid = datavideos.chid having name like '%".$_GET['querySearch']."%'";
        //echo $sql;
