...
<nav>
        <div id="background">
            ...
            <span id="home" class="links">
                ...
                <a href="../index.php" target="page">User Dashboard</a>
            </span>

            <span id="home" class="links">
                <i class="fa-solid fa-compact-disc"></i>
                <a href="../channel/index.php" target="page">Channels</a>
            </span>
    ...
    ?>
        ...
        <h2 class="uploadTitle">Upload a video</h2>
        <form action="action.php" method="post" enctype="multipart/form-data">
            <input type="text" name="name" id="name" placeholder="Enter the Name of Video">
            <label for="vid">Upload the video</label>
            <input type="file" name="vid" id="vid" required>
            <label for="pic">Upload the Thumbnail</label>
